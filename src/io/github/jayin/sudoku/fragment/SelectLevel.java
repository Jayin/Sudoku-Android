...
public class SelectLevel extends BaseFragment implements View.OnClickListener {

	@Override public View onCreateView(LayoutInflater inflater,
			ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.fragment_selectlevel, container,
				false);
...
//			((Main)getActivity()).setMainFragment(Game.newInstance(1, 2));
			((Main)getActivity()).setMainFragment(SudokuList.newInstance(1));
			break;
		case R.id.btn_lv2:
//			((Main)getActivity()).setMainFragment(Game.newInstance(2, 2));
			((Main)getActivity()).setMainFragment(SudokuList.newInstance(2));
			break;
		case R.id.btn_lv3:
//			((Main)getActivity()).setMainFragment(Game.newInstance(3, 2));
			((Main)getActivity()).setMainFragment(SudokuList.newInstance(3));
			break;
		case R.id.btn_lv4:
//			((Main)getActivity()).setMainFragment(Game.newInstance(4, 2));
			((Main)getActivity()).setMainFragment(SudokuList.newInstance(4));
			break;
		default:
			break;
		}
